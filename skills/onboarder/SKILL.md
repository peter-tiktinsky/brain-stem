...
| 3 | `scripts/build-brain-vault.sh` | Build a fresh "brain" vault: `vault-init/` tree (System Governance/ + Vault Writers/ + Meetings/), Plans/Skills symlinks, `<vault>/CLAUDE.md`. Prints the Obsidian-open confirm beat. |
