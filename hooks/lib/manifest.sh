...
#
# Co-shipped with the `plan-index` capability extraction. Centralizes the
# JSON manifest manipulation pattern that was previously re-implemented inline
# across every capability that emits findings or reads prior state.
#
# Usage:
